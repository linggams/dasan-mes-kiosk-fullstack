        ...
        <DialogPortal data-slot="dialog-portal">
            ...
            <DialogPrimitive.Content
                ...
                className={cn(
                    ...
                    fullScreen
                        ? "inset-0 w-screen h-screen max-w-none max-h-none rounded-none p-0"
                        : fullHorizontal
                        ? "inset-0 w-screen h-full max-w-none max-h-none rounded-none p-0"
